...
-- F5 = random(QQ^6,QQ^6)
-- F6 = random(QQ^6,QQ^6)
-- numSolsA({1,2,5},{{2,1},{2,1},{1,3},{1,3},{1,3},{1,3},{1,3}},{F1,F2,F3,F4,F5,F6},QQ) returns (0,5).
-- numSolsA({1,2,5},{{2,1},{2,1},{2,1},{1,3},{1,3},{1,3},{1,3}},{F1,F2,F3,F4,F5,F6},QQ) returns (0,3).
