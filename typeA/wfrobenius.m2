...
g = openOutAppend "data.txt";
problem = {{{2,4,6},{{1,2,3,5,4,6},{1,3,2,4,5,6},{1,3,2,4,5,6},{1,3,2,4,5,6},{1,3,2,5,4,6},{1,3,2,5,4,6},{1,3,2,5,4,6},{1,3,2,5,4,6}}},70};
g << typeALength(dimToCodim(problem#0#0,problem#0#1#0),problem#0#0#(-1)) << ", " << problem#1 << ", " 
f << problem << endl;
if problem#1 >= 7 then(
	f << frobeniusAlgorithm(problem#0,10009,problem#1,12*problem#1) << endl << endl);
if problem#1 == 3 then(
	f << frobeniusDegreeThree(problem#0,10009,problem#1,12*problem#1) << endl << endl);
if problem#1 == 4 then(
	f << frobeniusDegreeFour(problem#0,10009,problem#1,12*problem#1) << endl << endl);
if problem#1 == 5 then(
	f << frobeniusDegreeFive(problem#0,10009,problem#1,12*problem#1) << endl << endl);
if problem#1 == 6 then(
	    f << frobeniusDegreeSix(problem#0,10009,problem#1,12*problem#1) << endl << endl);
g << cpuTime() << endl;
quit();
