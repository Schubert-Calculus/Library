...
f = openOutAppend "frobenius_output-F1346.txt";
problem = {{{1,3,4,6},{{1,2,3,5,4,6},{1,2,3,5,4,6},{1,2,3,5,4,6},{1,2,4,3,5,6},{1,2,4,3,5,6},{1,2,4,3,5,6},{1,2,4,3,5,6},{2,1,4,5,3,6},{3,1,2,5,4,6}}},48};
