...
f = openOutAppend "frobenius_output-F1236.txt";
problem = {{{1,2,3,6},{{1,2,4,3,5,6},{1,2,4,3,5,6},{1,2,4,3,5,6},{1,2,4,3,5,6},{1,3,2,4,5,6},{1,3,2,4,5,6},{2,1,3,4,5,6},{2,1,3,4,5,6},{1,2,5,3,4,6},{1,2,5,3,4,6}}},22};
